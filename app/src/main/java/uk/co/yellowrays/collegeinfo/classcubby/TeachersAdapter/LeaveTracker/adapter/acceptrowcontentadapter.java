...
public class acceptrowcontentadapter extends BaseAdapter {
    ...
    public acceptrowcontentadapter(Activity mainActivity, String[] transactionid, String[] studentname,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            rowView = inflater.inflate(R.layout.teachers_leavetracker_accept_rowcontent, null);
            holder = new Holder();
