...
public class wardenpendingrowcontentadapter extends BaseAdapter {

    String[] transactionidvalue,studentnamevalue,classnamevalue,classsectionvalue,timesubmittedvalue,fromdatevalue,todatevalue;
    String[] totalleavedayscountvalue,leaverequestdetailsvalue,leavestatusnamevalue,userimagevalue;
    Context context;
    int textsize;
    private int lastPosition = -1 ;
    private static LayoutInflater inflater = null;

    public wardenpendingrowcontentadapter(Activity mainActivity, String[] transactionid, String[] studentname,
    ...
    public int getCount() {
        ...
        return transactionidvalue.length;
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            rowView = inflater.inflate(R.layout.warden_outgoingpermission_pending_rowcontent, null);
            holder = new Holder();
