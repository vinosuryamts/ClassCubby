...
public class Teachers_Dashboard extends android.support.v4.app.Fragment {
    ...
    public static Teachers_Dashboard newInstance(String param1) {
        Teachers_Dashboard fragment = new Teachers_Dashboard ();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        if (AppStatus.getInstance(getActivity().getApplicationContext()).isOnline()) {
            if(loogedinusertypeid.equals("2")){
                ...
                String[] prgmImages = {"http://www.classcubby.com/Webservice/Envy/images/teacherattendance.jpg","http://www.classcubby.com/Webservice/Envy/images/assignment.jpg","http://www.classcubby.com/Webservice/Envy/images/leave.jpg","http://www.classcubby.com/Webservice/Envy/images/events.png"};
