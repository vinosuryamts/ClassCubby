...
public class Teachers_LeaveTracker_Accepted_Click_Items extends android.support.v4.app.Fragment {
    ...
    public Teachers_LeaveTracker_Accepted_Click_Items() {
        // Required empty public constructor
    }

    public static Teachers_LeaveTracker_Accepted_Click_Items newInstance(String param1) {
        Teachers_LeaveTracker_Accepted_Click_Items fragment = new Teachers_LeaveTracker_Accepted_Click_Items();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        view = inflater.inflate(R.layout.teachers_leavetracker_accept_list_click_rowitems_xml, null);
    ...
    private void rejectpendingvalues(String transactionid, String rejectreason) {
        ...
        StringRequest studentrequest1 = new StringRequest(Request.Method.POST, loginconfig.key_leavetrackerreject_url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String s) {
                        JSONObject j = null;
                        try {
                            snackbar = Snackbar.make(mainview,"Leave Rejected Successfully",Snackbar.LENGTH_SHORT);
                            snackbar.show();
