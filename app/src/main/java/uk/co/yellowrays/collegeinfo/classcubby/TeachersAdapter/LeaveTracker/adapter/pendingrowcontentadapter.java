...
public class pendingrowcontentadapter extends BaseAdapter {
    ...
    public pendingrowcontentadapter(Activity mainActivity, String[] transactionid, String[] studentname,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            rowView = inflater.inflate(R.layout.teachers_leavetracker_pending_rowcontent, null);
            holder = new Holder();
