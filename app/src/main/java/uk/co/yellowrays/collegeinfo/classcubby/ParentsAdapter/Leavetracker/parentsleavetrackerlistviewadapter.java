...
public class parentsleavetrackerlistviewadapter extends BaseAdapter {
    ...
    public parentsleavetrackerlistviewadapter(Activity mainActivity, String[] strschoolid, String[] strschoolname,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            rowView = inflater.inflate(R.layout.parents_leavetracker_list_rowcontent_xml, null);
            holder = new Holder();
        ...
        holder.leavedayscount = (TextView) rowView.findViewById(R.id.leavedayscount);
        ...
        holder.leavedayscount.setTypeface(normaltypeface);
