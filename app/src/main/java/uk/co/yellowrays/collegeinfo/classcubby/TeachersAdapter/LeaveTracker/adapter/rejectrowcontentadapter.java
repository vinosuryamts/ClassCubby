...
public class rejectrowcontentadapter extends BaseAdapter {
    ...
    public rejectrowcontentadapter(Activity mainActivity, String[] transactionid, String[] studentname,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            rowView = inflater.inflate(R.layout.teachers_leavetracker_reject_rowcontent, null);
            holder = new Holder();
