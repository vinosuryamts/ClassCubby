...
public class wardenacceptrowcontentadapter extends BaseAdapter {
    ...
    public wardenacceptrowcontentadapter(Activity mainActivity, String[] transactionid, String[] studentname,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            rowView = inflater.inflate(R.layout.warden_outgoingpermission_accept_rowcontent, null);
            holder = new Holder();
